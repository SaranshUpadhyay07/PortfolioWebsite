  ...
  return (
    <div className="fixed-bottom d-flex justify-content-center">
      <div className="social text-white d-flex align-items-center justify-content-center px-3 py-2">
        <a href="https://github.com/SaranshUpadhyay07" className="mx-3 text-black " target="_blank" rel="noreferrer">
          <ion-icon name="logo-github"></ion-icon>
        </a>
        <a href="https://www.linkedin.com/in/saransh-upadhyay-81702020a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app " className="mx-3 link" target="_blank" rel="noreferrer">
        ...
        <a href="https://www.instagram.com/saransh_upadhyay07/ " target="_blank" className="mx-3 inst ">
